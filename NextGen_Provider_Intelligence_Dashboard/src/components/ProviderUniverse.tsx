      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
        <ChartCard title="Providers by Organization Type">
          <Plot
            data={[{
              ...
              x: byOrgType.labels,
              y: byOrgType.counts,
              marker: { color: orgColors, cornerradius: 4 },
            }]}
            layout={{ ...plotLayout, xaxis: { tickangle: 0 }, yaxis: { title: "Count" } }}
            config={plotConfig}
            className="w-full"
          />
        </ChartCard>
        ...
        <ChartCard title="Total Payment by Organization Type">
          <Plot
            ...
            layout={{ ...plotLayout, xaxis: { tickangle: 0 }, yaxis: { title: "Payment ($M)" } }}
            config={plotConfig}
            className="w-full"
          />
        </ChartCard>
        ...
        <ChartCard title="Provider Distribution by Specialty">
          <Plot
            data={[{
              ...
              orientation: "h",
              marker: { color: "#2962FF", cornerradius: 4 },
            }]}
            layout={{
              ...plotLayout,
              xaxis: { title: "Count" },
        ...
        <ChartCard title="Top 15 States by Provider Count">
          <Plot
            ...
            layout={{ ...plotLayout, xaxis: { tickangle: -45 }, yaxis: { title: "Count" } }}
            config={plotConfig}
            className="w-full"
          />
        </ChartCard>
